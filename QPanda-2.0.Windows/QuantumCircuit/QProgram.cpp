...
QWhileNode & createWhileProg(ClassicalCondition * ccCon, QNode * trueNode)
{
    ...
    temp->iPosition = _G_QNodeVector.getLastNode();  
    return *temp;
}
QProg & createQProg()
{
...
QMeasureNode & Measure(Qubit * targetQuBit, CBit *targetCbit)
{
    ...
    pMeasure->iPosition = _G_QNodeVector.getLastNode();
    return *pMeasure;
}
OriginQCircuit & createQCircuit()
{
...
int OriginQGateNode::getQuBitVector(vector<Qubit *>& vector) const
{
...
int OriginQGateNode::getQuBitNum() const
{
    return m_QuBitVector.size();
}
...
int OriginQGateNode::getControlVector(vector<Qubit *>& quBitVector) const
{
...
OriginQGateNode & QGateNodeFactory::getGateNode(string & name, Qubit * qbit)
{
    ...
    QGateNode->iPosition = _G_QNodeVector.getLastNode();
    return *QGateNode;
}
